...
public class BuySucessfullDemoBlaze implements Question<Boolean> {

    private final Map<String, String> dataJson;

    public BuySucessfullDemoBlaze(Map<String, String> dataJson) {
        this.dataJson = dataJson;
    }

    public static BuySucessfullDemoBlaze validateBuy(Map<String, String> dataJson) {
        return new BuySucessfullDemoBlaze(dataJson);
    }
    ...
    public Boolean answeredBy(Actor actor) {
        ...
        int monthActual = Integer.parseInt(dataJson.get("month").toString());
        String monthExpected = String.valueOf(monthActual-1);
